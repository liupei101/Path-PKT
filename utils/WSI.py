"""
This file is derived from CLAM (Lu et al., Nature Biomedical Engineering, 2021)
"""
import math
import os
import time
...
class WholeSlideImage(object):
    ...
    def initSegmentation(self, mask_file):
        ...
        from utils.wsi_utils import load_pkl
    ...
    def saveSegmentation(self, mask_file):
        ...
        from utils.wsi_utils import save_pkl
    ...
    def createPatches_bag_hdf5(self, save_path, patch_level=0, patch_size=256, step_size=256, save_coord=True, **kwargs):
        ...
        from utils.wsi_utils import savePatchIter_bag_hdf5, initialize_hdf5_bag
    ...
    def _getPatchGenerator(self, cont, cont_idx, patch_level, save_path, patch_size=256, step_size=256, custom_downsample=1,
        ...
        from utils.wsi_utils import isBlackPatch, isWhitePatch
        from utils.wsi_utils import isInContourV1, isInContourV2, isInContourV3_Easy, isInContourV3_Hard, Contour_Checking_fn
    ...
    def process_contours(self, save_path, patch_level=0, patch_size=256, step_size=256, **kwargs):
        from utils.wsi_utils import save_hdf5
    ...
    def visHeatmap(self, scores, coords, vis_level=-1, 
        ...
        def to_percentiles(_scores):
            from scipy.stats import rankdata
            _scores = rankdata(_scores, 'average')/len(scores) * 100   
            return _scores
